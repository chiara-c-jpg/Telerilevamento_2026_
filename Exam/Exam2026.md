...
```
## Realizzazione di due grafici a barre affiancati, tramite il pacchetto ggplot2
...
**Rosso** per **Suolo Nudo**
**Giallo** per **Piantagioni**
**Verde scuro**per **Foresta Primaria**
```r
...
tabella_classi_borneo <- data.frame(
  ...
  Anno2015 = round(perc_2015, 2),
  Anno2025 = round(perc_2025, 2)
)
...
# Grafico 2015
p1 <- ggplot(tabella_classi_borneo, aes(x=Classe, y=Anno2015, fill=Classe)) + 
...
# Grafico 2025
p2 <- ggplot(tabella_classi_borneo, aes(x=Classe, y=Anno2025, fill=Classe)) + 
  geom_bar(stat="identity") + 
  scale_fill_manual(values=colori_fissi) + 
  ylim(0, 100) +
...
# Realizzazione dei grafici (usando lo stesso nome "tabella_classi")
p1 <- ggplot(tabella_classi, aes(x=Classe, y=Anno_2015, fill=Classe)) + 
  geom_bar(stat="identity") + 
  scale_fill_manual(values=colori_classi) + 
  ylim(0, 100) +
  ggtitle("Copertura suolo - 2015") + 
  theme(axis.text.x=element_text(angle=45, hjust=1))

p2 <- ggplot(tabella_classi, aes(x=Classe, y=Anno_2025, fill=Classe)) + 
  geom_bar(stat="identity") + 
  scale_fill_manual(values=colori_classi) + 
  ylim(0, 100) +
  ggtitle("Copertura suolo - 2025") + 
  theme(axis.text.x=element_text(angle=45, hjust=1))
#  Unisci e stampa il grafico finale
grafico_finale <- p1 + p2 
print(grafico_finale)
