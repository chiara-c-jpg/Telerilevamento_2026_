...
# 1. Definiamo i margini per non tagliare assi e legende
par(mar = c(6, 4, 4, 6))

# 2. Imposti il layout affiancato
im.multiframe(1, 2)

# 3. Generi i due grafici
plot(dvi2015, main="DVI Borneo (2015)")
plot(dvi2025, main="DVI Borneo (2025)")
```
<img width="431" height="240" alt="DVI Borneo 2015-2025" src="https://github.com/user-attachments/assets/83d661dc-5297-4c91-a6ee-a04bb3786e24" />
