...
```
<img width="600" height="334" alt="DVI B 2015-2025" src="https://github.com/user-attachments/assets/cc241314-1d20-492d-8332-d944493d6c56" />
...
```
<img width="431" height="240" alt="NDVI plot differenzo B" src="https://github.com/user-attachments/assets/bcde5006-8270-485a-95d6-b9dd80d9f0c0" />
...
### 2. Applicazione della Classificazione
Ora che tutti gli indici e le loro differenze sono calcolati e visualizzati, usiamo la `matrice_class` che hai preparato prima. Solitamente la classificazione si applica sull'NDVI, poiché è l'indice migliore per discriminare nettamente suolo nudo, piantagioni e foresta intatta.

```markdown
### Classificazione delle immagini (2015 vs 2025)

Applichiamo la matrice di riclassificazione all'indice NDVI per mappare i cambiamenti del paesaggio suddividendoli nelle tre classi stabilite: deforestazione recente, piantagioni e foresta primaria.
...
# Plot delle mappe classificate
plot(ndvi2015_class, main="Mappa Classificata 2015")
plot(ndvi2025_class, main="Mappa Classificata 2025")
