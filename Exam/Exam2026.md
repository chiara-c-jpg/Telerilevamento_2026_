...
matrice_class <- matrix(c(
 -Inf, 0.4, 1, # Classe 1: Suolo nudo/Deforestazione (Rosso)
  0.4, 0.7, 2, # Classe 2: Piantagioni (Giallo)
  0.7, Inf, 3  # Classe 3: Foresta primaria intatta (Verde scuro)
), ncol = 3, byrow = TRUE)
...
```
<img width="600" height="334" alt="classificazione 2015-2025" src="https://github.com/user-attachments/assets/7248dc08-20fe-4819-9010-9fd79532baec" />
