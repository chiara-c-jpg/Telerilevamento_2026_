...
# Impostazione per visualizzare due grafici affiancati sulla stessa riga
par(mfrow=c(1,2))

# Visualizzazione dei grafici DVI
# Nota: usa una palette di colori adeguata, se hai caricato il pacchetto viridis usalo, 
# altrimenti R userà i colori di default
...
# Impostazione del layout con imageRy
par(mfrow=c(1,1))
...
# Grafico della differenza usando la palette magma
