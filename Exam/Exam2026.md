...
# impostazione della legenda tramite creazione di un data frame che associa i valori (1, 2, 3) ai nomi delle categorie
nomi_classi <- data.frame(id = 1:3, categoria = c("Deforestazione", "Piantagioni", "Foresta primaria"))

# Assegniamo queste etichette ai due raster classificati
levels(ndvi2015_class) <- nomi_classi
levels(ndvi2025_class) <- nomi_classi<img width="675" height="376" alt="classificazione 2015-2025" src="https://github.com/user-attachments/assets/aa0955a0-8a7d-490f-983a-ec5174b9d35a" />


# Layout affiancato per il confronto
par(mfrow=c(1,2))

# Plot delle mappe (terra userà in automatico i nomi definiti nei "levels")
