...
Applichiamo la matrice di riclassificazione all'indice NDVI, per mappare i cambiamenti del paesaggio suddividendoli nelle tre classi: deforestazione recente, piantagioni e foresta primaria. L'NDVI è l'indice migliore per discriminare nettamente le tre classi di aree vegetazionali tramite il raggruppamento dei pixel con la stessa firma spettrale in categorie.
...
* **Dinamica del Suolo Nudo e della Deforestazione:** La barra rossa traccia le aree di suolo nudo e i fenomeni di deforestazione recente, evidenziando le fasi di disboscamento che hanno interessato il territorio.

Nel complesso, il confronto multitemporale quantifica in modo immediato l'impatto delle pressioni antropiche e la frammentazione dell'ecosistema nell'area del Kalimantan.
